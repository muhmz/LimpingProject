...
function [Doppler, mds_f, t] = computeDopplerFromRange(Rng_dft, Nfftv, df_rng, df_dopp, prf, fc, Dopp_axis)
...
signal_HPF = designfilt('highpassfir', 'StopbandFrequency',0.5, 'PassbandFrequency',5, 'StopbandAttenuation', 15, 'PassbandRipple', 1, 'SampleRate', 1000, 'DesignMethod', 'equiripple');
